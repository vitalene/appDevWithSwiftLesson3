...
//:
//: Swift has a way to do this. The official name for this is _string interpolation_ which sounds complicated and difficult, but it really is basically “fill in the blanks”.
//:
