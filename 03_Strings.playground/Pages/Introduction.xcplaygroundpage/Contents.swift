...
//: Imagine a string of beads. Each bead may look different, but they are all strung together in a particular order.
//: ![string of beads](StringOfBeads.png)
//: Usually a single letter (like an “H” for example) is not very useful all by itself. Words are made up of a whole string of letters. So programmers call text a _string_. And a string can be just about any text you can imagine.
